            ...
            <nav className='h-screen hidden lg:flex py-8 bg-foreground flex-col justify-between text-white text-opacity-80'>
                <div>
                    ...
                    <ul className='my-6 flex flex-col'>
                        <SideBarLink href="/admin" icon={faHouse}>Accueil</SideBarLink>
                        <SideBarLink href="/admin/doctors" icon={faUserDoctor}>Docteurs</SideBarLink>
                        <SideBarLink href="/admin/secretaries" icon={faUserNurse}>Secrétaires</SideBarLink>
                        <SideBarLink href="/admin/users" icon={faUser}>Utilisateurs</SideBarLink>
                        <SideBarLink href="/admin/settings" icon={faGears}>Parametres</SideBarLink>
                    </ul>
                </div>
                <form action={logout}>
